...
- The visual source of truth is `../design-references/selected-safety-review-cockpit.png`.
- Preserve the selected Safety Review Cockpit layout, with the full-height deep navy navigation treatment from the earlier Clinical Command Center direction.
